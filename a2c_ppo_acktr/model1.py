...
class Policy(nn.Module):
    ...
    def act(self, inputs, deterministic=False, output_mask=False, output_feat=False,
            ):
        value, actor_features = self.base(inputs, output_mask=output_mask,
...
class CNNBase(NNBase):
    ...
    def forward(self, inputs, output_mask=False,
                output_feat=False,
                ):
